    ...
    class ColumnDalController : DalController
    {
        ...
        public bool Insert(ColumnDTO column)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionString))
            {
                ...
                {
                    connection.Open();
                    command.CommandText = $"INSERT INTO {_tableName} ({ColumnDTO.BoardIDColumnName},{ColumnDTO.LimitColumnName},{ColumnDTO.NameColumnName},{ColumnDTO.ColOrdColumnName}) " +
                        $"VALUES (@idVal,@limitVal,@nameVal,@ordVal);";
                    ...
                    SQLiteParameter ordParam = new SQLiteParameter(@"ordVal", column.ColOrdinal);
        ...
        {
            ColumnDTO result = new ColumnDTO((long)reader.GetValue(0), reader.GetString(1), (long)reader.GetValue(2), (long)reader.GetValue(3));
            return result;
        }
